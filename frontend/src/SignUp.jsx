      ...
      <div className='signup-container'>
        ...
        <form onSubmit={clickSubmit} className='signup-form'>
          ...
          <div className='formGroup'>
            ...
            <input type='password' id='pswd' name='pswd' value={data.password} onChange={changeValues} placeholder='Enter password' required />
          </div>

          {/* <div className='formGroup'>
            <label htmlFor='cpswd'>Confirm-Password</label>
            <input type='password' id='cpswd' name='cpswd' value={data.confirm_password} onChange={changeValues} placeholder='Confirm password' required />
          </div> */}
